...
import com.biit.abcd.serialization.expressions.ExpressionSymbolDeserializer;
import com.biit.abcd.serialization.expressions.ExpressionSymbolSerializer;
 ...
 */
@Entity
@JsonDeserialize(using = ExpressionSymbolDeserializer.class)
@JsonSerialize(using = ExpressionSymbolSerializer.class)
