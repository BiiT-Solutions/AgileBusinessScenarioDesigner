...
public class FormDao extends AnnotatedGenericDao<Form, Long> implements IFormDao {
	...
	public int updateValidTo(String label, int version, Long organizationId, Timestamp validTo) {
		Query query = getEntityManager()
				.createQuery(
						"UPDATE Form SET availableTo = CASE WHEN :availableTo > availableFrom THEN :availableTo ELSE availableFrom END where label = :label and version = :version and organizationId = :organizationId");
