...
public class FormComparator {
    ...
    private void compare(StorableObject object1, StorableObject object2, boolean checkIds) throws StorableObjectNotEqualsException {
        ...
        if (checkIds && Objects.equals(object1.getId(), object2.getId())) {
            throw new StorableObjectNotEqualsException("Storable objects has same id!: '" + object1.getId() + "'");
        }

        if (checkIds && Objects.equals(object1.getComparationId(), object2.getComparationId())) {
            throw new StorableObjectNotEqualsException(
    ...
    private void compare(Expression object1, Expression object2, boolean checkIds)
        ...
        try {
            compareExpressionValue(object1.getValue(), object2.getValue(), checkIds);
        ...
        // Custom variables cannot be reset id, if they are, we duplicate it when storing into database.
    ...
    private void compareExpressionValue(Object object1, Object object2, boolean checkIds)
        ...
        if (object1 instanceof TreeObject) {
            compare((TreeObject) object1, (TreeObject) object2, checkIds);
        } else if (object1 instanceof ExpressionChain) {
            compare((ExpressionChain) object1, (ExpressionChain) object2, checkIds);
        } else if (object1 instanceof GlobalVariable) {
            compare((GlobalVariable) object1, (GlobalVariable) object2, checkIds);
        } else if (object1 instanceof List) {
            if (!((List<?>) object1).isEmpty() && ((List<?>) object1).get(0) instanceof Expression) {
                compare((List<Expression>) object1, (List<Expression>) object2, checkIds);
            }
    ...
    private void compare(ExpressionChain object1, ExpressionChain object2, boolean checkIds)
            throws StorableObjectNotEqualsException, ExpressionNotEqualsException, GlobalVariableNotEqualsException,
            VariableDataNotEqualsException, CustomVariableNotEqualsException {
        ...
        while (expressionsIterator1.hasNext() || expressionsIterator2.hasNext()) {
            ...
            if (expression1 instanceof ExpressionChain) {
                compare((ExpressionChain) expression1, (ExpressionChain) expression2, checkIds);
            }
            compare(expression1, expression2, checkIds);
        }
    }

    private void compare(List<Expression> object1, List<Expression> object2, boolean checkIds)
    ...
    private void compare(TreeObject object1, TreeObject object2, boolean checkIds) throws TreeObjectNotEqualsException,
        ...
        for (int i = 0; i < object1.getChildren().size(); i++) {
            compare(object1.getChildren().get(i), object2.getChildren().get(i), checkIds);
        }
    ...
    private void compare(TableRule object1, TableRule object2, boolean checkIds)
        ...
        while (tableRuleRowIterator1.hasNext() || tableRuleRowIterator2.hasNext()) {
            ...
            compare(tableRuleRowIterator1.next(), tableRuleRowIterator2.next(), checkIds);
        }
    }

    private void compare(TableRuleRow object1, TableRuleRow object2, boolean checkIds)
            throws StorableObjectNotEqualsException, ExpressionNotEqualsException,
            CustomVariableNotEqualsException, GlobalVariableNotEqualsException, VariableDataNotEqualsException {
        if (object1 == null && object2 == null) {
            return;
        }
        ...
        compare(object1.getConditions(), object2.getConditions(), checkIds);
        compare(object1.getActions(), object2.getActions(), checkIds);
    }

    private void compare(Rule object1, Rule object2, boolean checkIds)
    ...
    private void compare(Size object1, Size object2, boolean checkIds) throws SizeNotEqualsException, StorableObjectNotEqualsException {
        if (object1 == null && object2 == null) {
            return;
        }
        if (object1 instanceof StorableObject || object2 instanceof StorableObject) {
    ...
    private void compare(Point object1, Point object2, boolean checkIds)
    ...
    private void compare(DiagramElement object1, DiagramElement object2, boolean checkIds)
        ...
        compare(object1.getSize(), object2.getSize(), checkIds);
        ...
        compare(object1.getPosition(), object2.getPosition(), checkIds);
    ...
    private void compare(DiagramChild object1, DiagramChild object2, boolean checkIds) throws StorableObjectNotEqualsException,
        ...
        compare((DiagramElement) object1, (DiagramElement) object2, checkIds);
        ...
        if (object1.getDiagram() != null && object2.getDiagram() != null) {
            compare(object1.getDiagram(), object2.getDiagram(), checkIds);
        }
    }

    private void compare(DiagramExpression object1, DiagramExpression object2, boolean checkIds)
            throws StorableObjectNotEqualsException, DiagramObjectNotEqualsException, ExpressionNotEqualsException,
            CustomVariableNotEqualsException, GlobalVariableNotEqualsException, VariableDataNotEqualsException,
            SizeNotEqualsException, PointNotEqualsException, BiitTextNotEqualsException {
        compare((DiagramElement) object1, (DiagramElement) object2, checkIds);
        compare(object1.getExpression(), object2.getExpression(), checkIds);
    }

    private void compare(DiagramFork object1, DiagramFork object2, boolean checkIds)
            throws StorableObjectNotEqualsException, DiagramObjectNotEqualsException, ExpressionNotEqualsException,
            CustomVariableNotEqualsException, GlobalVariableNotEqualsException, VariableDataNotEqualsException,
            SizeNotEqualsException, PointNotEqualsException, BiitTextNotEqualsException {
        compare((DiagramElement) object1, (DiagramElement) object2, checkIds);
        ...
        compare(object1.getReference(), object2.getReference(), checkIds);
    }

    private void compare(Node object1, Node object2, boolean checkIds) throws NodeNotEqualsException, StorableObjectNotEqualsException {
        if (object1 == null && object2 == null) {
            return;
        }
        if (object1 instanceof StorableObject || object2 instanceof StorableObject) {
    ...
    private void compare(DiagramLink object1, DiagramLink object2, boolean checkIds) throws DiagramObjectNotEqualsException, NodeNotEqualsException, VariableDataNotEqualsException, CustomVariableNotEqualsException, StorableObjectNotEqualsException, GlobalVariableNotEqualsException, ExpressionNotEqualsException {
        ...
        compare(object1.getSource(), object2.getSource(), checkIds);
        compare(object1.getTarget(), object2.getTarget(), checkIds);
        compare(object1.getExpressionChain(), object2.getExpressionChain(), checkIds);

    }

    private void compare(DiagramRepeat object1, DiagramRepeat object2, boolean checkIds)
            throws StorableObjectNotEqualsException, DiagramObjectNotEqualsException, SizeNotEqualsException,
            PointNotEqualsException, BiitTextNotEqualsException {
        compare((DiagramElement) object1, (DiagramElement) object2, checkIds);
    }

    private void compare(DiagramRule object1, DiagramRule object2, boolean checkIds)
            throws StorableObjectNotEqualsException, DiagramObjectNotEqualsException, SizeNotEqualsException,
            PointNotEqualsException, BiitTextNotEqualsException, VariableDataNotEqualsException, CustomVariableNotEqualsException,
            GlobalVariableNotEqualsException, ExpressionNotEqualsException, RuleNotEqualsException {
        compare((DiagramElement) object1, (DiagramElement) object2, checkIds);
        ...
        compare(object1.getRule(), object2.getRule(), checkIds);
    }

    private void compare(DiagramSink object1, DiagramSink object2, boolean checkIds)
            throws StorableObjectNotEqualsException, DiagramObjectNotEqualsException, ExpressionNotEqualsException,
            CustomVariableNotEqualsException, GlobalVariableNotEqualsException, VariableDataNotEqualsException,
            SizeNotEqualsException, PointNotEqualsException, BiitTextNotEqualsException {
        compare((DiagramExpression) object1, (DiagramExpression) object2, checkIds);
    }

    private void compare(DiagramSource object1, DiagramSource object2, boolean checkIds)
            throws StorableObjectNotEqualsException, DiagramObjectNotEqualsException, SizeNotEqualsException,
            PointNotEqualsException, BiitTextNotEqualsException {
        compare((DiagramElement) object1, (DiagramElement) object2, checkIds);
    }

    private void compare(DiagramTable object1, DiagramTable object2, boolean checkIds) throws StorableObjectNotEqualsException,
            DiagramObjectNotEqualsException, SizeNotEqualsException, PointNotEqualsException,
        ...
        compare(object1.getTable(), object2.getTable(), checkIds);
    }

    private void compare(DiagramObject object1, DiagramObject object2, boolean checkIds)
            throws StorableObjectNotEqualsException, DiagramObjectNotEqualsException, ExpressionNotEqualsException,
            CustomVariableNotEqualsException, GlobalVariableNotEqualsException, VariableDataNotEqualsException,
        ...
        if (object1 instanceof DiagramSink) {
            compare((DiagramSink) object1, (DiagramSink) object2, checkIds);
        } else if (object1 instanceof DiagramSource) {
            compare((DiagramSource) object1, (DiagramSource) object2, checkIds);
        } else if (object1 instanceof DiagramRepeat) {
            compare((DiagramRepeat) object1, (DiagramRepeat) object2, checkIds);
        } else if (object1 instanceof DiagramFork) {
            compare((DiagramFork) object1, (DiagramFork) object2, checkIds);
        } else if (object1 instanceof DiagramLink) {
            compare((DiagramLink) object1, (DiagramLink) object2, checkIds);
        } else if (object1 instanceof DiagramTable) {
            compare((DiagramTable) object1, (DiagramTable) object2, checkIds);
        } else if (object1 instanceof DiagramRule) {
            compare((DiagramRule) object1, (DiagramRule) object2, checkIds);
        } else if (object1 instanceof DiagramChild) {
            compare((DiagramChild) object1, (DiagramChild) object2, checkIds);
    ...
    private void compare(Diagram object1, Diagram object2, boolean checkIds)
    ...
    public void compare(Form form1, Form form2) throws TreeObjectNotEqualsException, StorableObjectNotEqualsException,
        ...
        for (int i = 0; i < form2.getChildren().size(); i++) {
            compare(form1.getChildren().get(i), form2.getChildren().get(i), this.checkIds);
        }
        ...
        while (expressionsIterator1.hasNext() || expressionsIterator2.hasNext()) {
            ...
            compare(expressionsIterator1.next(), expressionsIterator2.next(), this.checkIds);
        }
        ...
        while (tableRulesIterator1.hasNext() || tableRulesIterator2.hasNext()) {
            ...
            compare(tableRulesIterator1.next(), tableRulesIterator2.next(), this.checkIds);
        }
        ...
        while (rulesIterator1.hasNext() || rulesIterator2.hasNext()) {
            ...
            compare(rulesIterator1.next(), rulesIterator2.next(), this.checkIds);
        }
        ...
        while (diagramIterator1.hasNext() || diagramIterator2.hasNext()) {
            ...
            compare(diagramIterator1.next(), diagramIterator2.next(), this.checkIds);
        }
    }
