...
public class FormCustomVariablesTest extends AbstractTransactionalTestNGSpringContextTests {
	...
	public void variableReplaced() throws FieldTooLongException, UnexpectedDatabaseException,
		...
		CustomVariable formCustomVariable1 = new CustomVariable(form, "var1", CustomVariableType.DATE,
				CustomVariableScope.FORM);
		form.add(formCustomVariable1);

		CustomVariable formCustomVariable2 = new CustomVariable(form, "var2", CustomVariableType.DATE,
				CustomVariableScope.FORM);
		form.add(formCustomVariable2);

		formDao.makePersistent(form);

		form.remove(formCustomVariable1);
		formCustomVariable2.setName("var1");
