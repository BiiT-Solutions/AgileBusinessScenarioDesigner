...
public class StringInputWindow extends AcceptCancelWindow{
	...
	public StringInputWindow(){
		...
		setWidth(width);
		setHeight(height);
		cancelButton.setCaption(ServerTranslate.tr(LanguageCodes.CANCEL_BUTTON_CAPTION));
		cancelButton.setDescription(ServerTranslate.tr(LanguageCodes.CANCEL_BUTTON_TOOLTIP));
	}
