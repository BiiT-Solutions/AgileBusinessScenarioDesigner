	...
	private static void createTestScenarioObject(TreeObject formTreeObject, TreeObject testScenarioTreeObjectParent) {
		try {
			if (formTreeObject instanceof Category) {
				...
				originalReferenceTreeObjectMap.put(testScenarioCategory.getOriginalReference(), testScenarioCategory);
				// Copy children
				...
				originalReferenceTreeObjectMap.put(testScenarioQuestion.getOriginalReference(), testScenarioQuestion);
			}
