...
import com.biit.abcd.webpages.elements.form.variables.FormVariablesUpperMenu;
import com.biit.abcd.webpages.elements.form.variables.VariableTable;
	...
	private FormVariablesUpperMenu initUpperMenu() {
		...
		upperMenu.addNewVariableButtonClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				customVariable.setCreatedBy(UserSessionHandler.getUser().getUniqueId());
