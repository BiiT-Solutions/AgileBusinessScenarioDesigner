...
public class QuestionTabFormVariablesLayout extends TabFormVariablesLayout {
	private static final long serialVersionUID = 703942162061962183L;

	public QuestionTabFormVariablesLayout() {
		super();
	...
	protected void initializeFormQuestionTable() {
		setFormQuestionTable(new TreeObjectTable());
