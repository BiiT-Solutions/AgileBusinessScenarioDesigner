...
public class FormDiagramBuilderUpperMenu extends UpperMenu {
	...
	private void defineMenu() {
		...
		deleteDiagramButton = new IconButton(LanguageCodes.FORM_DIAGRAM_BUILDER_UPPER_BUTTON_CLEAR_CAPTION,
				ThemeIcons.DIAGRAM_BUILDER_PAGE, LanguageCodes.FORM_DIAGRAM_BUILDER_UPPER_BUTTON_CLEAR_TOOLTIP);
