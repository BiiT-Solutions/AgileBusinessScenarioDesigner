...
public class TableRuleTest {
	...
	private final static String DATE_YEARS_VAR = "yearsVar";
	private final static String DATE_MONTHS_VAR = "monthsVar";
	private final static String DATE_DAYS_VAR = "daysVar";
	private final static String DATE_DATE_VAR = "dateVar";
	...
	Form form = new Form();
	Category algemeen = new Category();
	Question birthdate = new Question();
	Question gender = new Question();
	Answer male = new Answer();
	Answer female = new Answer();
	Question height = new Question();
	Question heightFather = new Question();
	Question heightMother = new Question();
	Question weight = new Question();
	Category gezondheid = new Category();
	Question health = new Question();
	Answer yes = new Answer();
	Answer no = new Answer();
	Category lifestyle = new Category();
	Group voeding = new Group();
	Question breakfast = new Question();
	Answer breakfastA = new Answer();
	Answer breakfastB = new Answer();
	Answer breakfastC = new Answer();
	Answer breakfastD = new Answer();
	Answer breakfastE = new Answer();
	Question fruit = new Question();
	Answer fruitA = new Answer();
	Answer fruitB = new Answer();
	Answer fruitC = new Answer();
	Answer fruitD = new Answer();
	Answer fruitE = new Answer();
	Question fruitAmount = new Question();
	Question vegetables = new Question();
	Answer vegetablesA = new Answer();
	Answer vegetablesB = new Answer();
	Answer vegetablesC = new Answer();
	Answer vegetablesD = new Answer();
	Answer vegetablesE = new Answer();
	Question vegetablesAmount = new Question();
	Question drinks = new Question();
	Answer drinksA = new Answer();
	Answer drinksB = new Answer();
	Answer drinksC = new Answer();
	Answer drinksD = new Answer();
	...
	// public void testTableRuleSeveralConditionsLoadAndExecution() throws
	// ExpressionInvalidException,
	// NotValidChildException, NotValidOperatorInExpression,
	// ChildrenNotFoundException, RuleInvalidException,
	// FieldTooLongException, IOException, CategoryDoesNotExistException,
	...
	// formDrools.runDroolsRules(submittedForm);
	// SubmittedForm subForm = (SubmittedForm) submittedForm;
	// Assert.assertEquals("overweight",
	// subForm.getVariableValue(BMI_VARIABLE_NAME));
	// // FormToDroolsExporter formDrools = new FormToDroolsExporter();
	...
	// * @throws IOException
	// */
	// private Form createRuleTestForm() throws NotValidChildException,
...
//		// Date(Years) == ValueNumber
//		TableRuleRow ruleRow = new TableRuleRow();
//		ruleRow.addCondition(new ExpressionValueTreeObjectReference(birthdate, QuestionUnit.YEARS));
//		ruleRow.addCondition(new ExpressionChain(new ExpressionOperatorLogic(AvailableOperator.EQUALS),
//				new ExpressionValueNumber(7.)));
//		ruleRow.setAction(new ExpressionChain(new ExpressionValueCustomVariable(form, dateYearsFunc),
//				new ExpressionOperatorMath(AvailableOperator.ASSIGNATION), new ExpressionValueString("DateYearsWorking")));
//		tableRule.getRules().add(ruleRow);
//
//		ruleRow = new TableRuleRow();
//		ruleRow.addCondition(new ExpressionValueTreeObjectReference(birthdate, QuestionUnit.MONTHS));
//		ruleRow.addCondition(new ExpressionChain(new ExpressionOperatorLogic(AvailableOperator.EQUALS),
//				new ExpressionValueNumber(6.)));
//		ruleRow.setAction(new ExpressionChain(new ExpressionValueCustomVariable(form, dateMonthsFunc),
//				new ExpressionOperatorMath(AvailableOperator.ASSIGNATION), new ExpressionValueString("DateMonthsWorking")));
//		tableRule.getRules().add(ruleRow);
//
//		ruleRow = new TableRuleRow();
//		ruleRow.addCondition(new ExpressionValueTreeObjectReference(birthdate, QuestionUnit.DAYS));
//		ruleRow.addCondition(new ExpressionChain(new ExpressionOperatorLogic(AvailableOperator.EQUALS),
//				new ExpressionValueNumber(84.)));
//		ruleRow.setAction(new ExpressionChain(new ExpressionValueCustomVariable(form, dateDaysFunc),
//				new ExpressionOperatorMath(AvailableOperator.ASSIGNATION), new ExpressionValueString("DateDaysWorking")));
//		tableRule.getRules().add(ruleRow);
//		
//		ruleRow = new TableRuleRow();
//		ruleRow.addCondition(new ExpressionValueTreeObjectReference(birthdate, QuestionUnit.DATE));
...
//		ruleRow.setAction(new ExpressionChain(new ExpressionValueCustomVariable(form, dateDateFunc),
//				new ExpressionOperatorMath(AvailableOperator.ASSIGNATION), new ExpressionValueString("DateDateWorking")));
//		tableRule.getRules().add(ruleRow);
