    ...
    alter table test_scenario 
       add constraint UKr9xm5nx5hucs0inuegkqf6v5e unique (name, form_id);
    ...
    alter table custom_variables 
       add constraint FKofqllbnlgucyxg8808kfpr669 
       foreign key (form) 
       references tree_forms (id);

    alter table diagram_child 
       add constraint FK265ypxhhltu8k2e5h3ghgsgh6 
       foreign key (diagram) 
    ...
    alter table diagram_expression 
       add constraint FKl7y1uhbxxolpp7chwndqblrnr 
    ...
    alter table diagram_fork_references 
       add constraint FKdrjb9y0vk1m2gv9typtkoygwl 
       foreign key (diagram_fork) 
       references diagram_fork (id);

    alter table diagram_links 
       add constraint FKhwluack74cyjxt7lml2rlpb26 
       foreign key (expression_chain) 
       references expressions_chain (id);

    alter table diagram_links 
       add constraint FKhc260s65g5yelkwplihe9pdqa 
       foreign key (source) 
       references diagram_nodes (id);

    alter table diagram_links 
       add constraint FKrgh6x4ehhj71mrgxsl67y968d 
       foreign key (target) 
       references diagram_nodes (id);
    ...
    alter table diagram_rule 
       add constraint FKrm6h78wl1srf3kbnf33jynobg 
       foreign key (rule) 
       references rule (id);
    ...
    alter table diagram_table 
       add constraint FKhcvye2rq1x0tuwfr6f9yf6hml 
    ...
    alter table elements_of_diagram 
       add constraint FKhmn18qjaoq2t5aljhhrneuf99 
       foreign key (diagram) 
       references diagram (id);

    alter table expression_value_custom_variable 
       add constraint FKi6wdpyf24nsu9rgsunqw44vll 
       foreign key (custom_variable) 
       references custom_variables (id);

    alter table expression_value_generic_custom_variable 
       add constraint FK19jy1u1v4svuervwnvrsdx9x2 
       foreign key (custom_variable) 
       references custom_variables (id);

    alter table expression_value_global_variable 
       add constraint FKbgnbltoh88bjm7nb7yy3wa2px 
       foreign key (global_variable) 
       references global_variables (id);

    alter table expressions_chain_expressions 
       add constraint FKmgcyreeq15ow8vpvnamrbye4r 
       foreign key (expressions_chain) 
       references expressions_chain (id);

    alter table global_variables_variable_data 
       add constraint FKeq3d2q9hi927009f9gy5vr2p2 
       foreign key (global_variable) 
       references global_variables (id);

    alter table rule 
       add constraint FK6dpoq5m6quylo00mft4j5yeab 
       foreign key (actions) 
       references expressions_chain (id);

    alter table rule 
       add constraint FKswr158prgpo29haoieeoyvbp6 
       foreign key (conditions) 
       references expressions_chain (id);

    alter table rule_decision_table_row 
       add constraint FKgstr540lkcvateagq1lt7xd08 
       foreign key (actions) 
       references expressions_chain (id);

    alter table rule_decision_table_row 
       add constraint FKirj92elay1r2qir5aja1w1nlp 
       foreign key (conditions) 
       references expressions_chain (id);

    alter table rule_decision_table_row_rules 
       add constraint FKit44pmsyr0v7otp5ap2d7inlx 
       foreign key (rule) 
       references rule_decision_table_row (id);

    alter table rule_decision_table_row_rules 
       add constraint FKhinuoj34qdv5po5i9t83d9su8 
       foreign key (rule_decision_table) 
       references rule_decision_table (id);

    alter table test_answer_multi_checkbox_values 
       add constraint FK1a31ia61sr39rfcyys5tklnx0 
       foreign key (test_answer_multi_checkbox) 
       references test_answer_multi_checkbox (id);

    alter table test_scenario 
       add constraint FKqw9akiu13jxdvprsaf0563eg0 
       foreign key (test_scenario_form) 
       references test_scenario_form (id);

    alter table tree_forms_diagram 
       add constraint FKtcsk86gqujjpo1oi701076flb 
       foreign key (diagram) 
       references diagram (id);

    alter table tree_forms_diagram 
       add constraint FK6pp9i9osbgxgevr9krxsribaw 
       foreign key (form) 
       references tree_forms (id);

    alter table tree_forms_expressions_chain 
       add constraint FKpyy6gpfdn7hgwqx8cmky4n6ag 
       foreign key (expression_chain) 
       references expressions_chain (id);

    alter table tree_forms_expressions_chain 
       add constraint FKnsnemgp8d23ixwsjydiiq45wu 
       foreign key (form) 
       references tree_forms (id);

    alter table tree_forms_rule 
       add constraint FKoa97cphicye9jx9qf39jqq4y1 
       foreign key (rule) 
       references rule (id);

    alter table tree_forms_rule 
       add constraint FK1ka1lgsbd6fkevwgx0bx8hmo0 
       foreign key (form) 
       references tree_forms (id);

    alter table tree_forms_rule_decision_table 
       add constraint FK9xu3b7jfrqk45nvfo5vbecsg0 
       foreign key (table_rule) 
       references rule_decision_table (id);

    alter table tree_forms_rule_decision_table 
       add constraint FK1mf05ufcjr65hlie3qjlu8o1w 
       foreign key (form) 
       references tree_forms (id);
