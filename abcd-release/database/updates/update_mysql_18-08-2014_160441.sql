    ...
    alter table PARENT_OF_CHILDREN 
        drop constraint UK_oj9m32v898q47n973v4c4hmgi;
    ...
    alter table diagram_fork_expression_value_tree_object_reference 
        drop constraint UK_qjdox15ikgx1yrjmmwmi60s5o;
    ...
    alter table global_variable_data_set 
        drop constraint UK_pttoh2ouj3te5iqnhvym6l2g1;
    ...
    alter table tree_forms 
        drop constraint UK_2lpmhpxyj0ahdclkdlep5fn9t;
    ...
    alter table tree_forms_expressions_chain 
        drop constraint UK_o92uqjo7rspntjcyeohxrlktl;
